...
late". The Django admin's "add election" form
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--nomination-opens", required=True, help="Date (YYYY-MM-DD) — begins anywhere.")
        parser.add_argument("--nomination-closes", required=True, help="Date (YYYY-MM-DD), AOE — ends everywhere.")
        parser.add_argument("--voting-opens", required=True, help="Date (YYYY-MM-DD) — begins anywhere.")
        parser.add_argument("--voting-closes", required=True, help="Date (YYYY-MM-DD), AOE — ends everywhere.")
